...
Help documents are formatted using <a href="http://daringfireball.net/projects/markdown/syntax">Markdown</a>. There are regular HTML tags that Shade recognizes and converts on build time. These tags serve different purposes:

<h2>Subsections</h2>

<h2 data-sub="links">Linking Elements</h2>

Elements are linked using regular <code>a</code> tags. What turns them into dynamic links are following <code>data</code> attributes:

* <code>data-target</code> - Type of the element that link is targeting. Possible values:
** <code>page</code> - targets a book page.

<pre data-syntax="html"><a data-target="page" data-page-name="project-config" data-book-name="shade">Project Configuration</a></pre>
