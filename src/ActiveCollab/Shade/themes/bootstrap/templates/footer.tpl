<div class="container" id="footer">
  ...
  <div class="rights"><p>&copy; <{if $copyright_since}><{$copyright_since}>-<{/if}><{'Y'|date}> &middot; <{$copyright}>, All rights reserved. Built with <a href="https://www.activecollab.com/labs/shade" title="Shade builds help portals from static files">Shade v1.0.0</a>.</p></div>
